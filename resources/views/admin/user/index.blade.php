                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($users as $user)
                                    <tr id="order-{{ $user->id }}">
                                        ...
                                        <td>
                                            <a href="{{ route('user.edit', $user->id) }}" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1">{{ $user->name }}</a>
                                        </td>
                                        <td>
                                            @if ($user->is_active == 1)
                                        ...
                                        <td class="text-end">
                                            <a href="{{ route('user.edit', $user->id) }}" data-toggle="tooltip" title="Düzenle" class="btn btn-icon btn-light btn-hover-primary btn-sm"><i class="far fa-edit text-warning icon-lg"></i></a>
