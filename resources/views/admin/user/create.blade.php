    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form class="form d-flex flex-column flex-lg-row" action="{{ route('user.store') }}" method="POST" id="form">
                    @method('POST')
                    @csrf
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10 row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input class="form-control" type="email" name="email" autocomplete="disabled" value="" required/>
                                                    <div class="text-muted fs-7">Bu alan zorunludur.</div>
                                                </div>
                                            </div>
                                            <div class="mb-10 row">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" id="submit" class="btn btn-primary">Oluştur</button>
                        </div>
                    </div>
                </form>
            </div>
