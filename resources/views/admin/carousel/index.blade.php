        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Slider Listesi</h1>
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">Slider Listesi</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="card card-flush">
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar">
                            <a href="{{ route('carousel.create') }}" class="btn btn-primary">Yeni Resim</a>
                        </div>
                    </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="dataTable">
                            ...
                            @foreach ($carousels as $carousel)
                                <tr id="order-{{  $carousel->id }}">
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('carousel.edit', $carousel->id) }}" data-toggle="tooltip" title="Düzenle" class="btn btn-icon btn-light btn-hover-primary btn-sm"><i class="far fa-edit text-warning icon-lg"></i></a>
                                        <a href="#" type="button" data-toggle="tooltip" title="Sil" class="btn btn-icon btn-light btn-hover-primary btn-sm"
                                           data-url="{{ route('carousel.destroy',$carousel->id) }}"
                                           data-method="delete"
                                           data-id="{{ $carousel->id }}"
