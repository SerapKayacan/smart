    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('tab-panel.index') }}" class="text-muted text-hover-primary">Tab Panel
                                Listesi</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form class="form d-flex flex-column flex-lg-row" action="{{ route('tab-panel.update', $tabPanel->id) }}"
                                                            ...
                                                            <span class="input-group-btn">
                                                                <a class="uploadImage btn btn-primary text-white btn-sm">
                                                                   ...
                                                                   <input type="text" name="uploaded_banner_image"
                                                                          class="d-none"
                                                                          value="{{ $tabPanel->getFirstMediaUrl('banner', 'large') }}">
                                            ...
                                            <div class="mb-10 row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input class="form-control" name="icon"
                                                           value="{{ $tabPanel->icon }}" required/>
                                                    <div class="text-muted fs-7">Bu alan zorunludur.</div>
                                                </div>
                                            </div>
                                            <div class="mb-10 row">
                                                <div class="col-sm-12">
                                                    <label class="form-label"> Nav Buton Yazısı</label>
                                                    <textarea class="form-control" name="nav_button_text"
                                                    >{{$tabPanel->nav_button_text }}</textarea>
                                            ...
                                            <div class="mb-10 row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea class="form-control ckeditors" id="title" name="title"
                                                              rows="2">{{$tabPanel->title}}</textarea>
                                                    <div class="text-muted fs-7">Bu alan zorunlu değildir.</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-10 row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea class="form-control ckeditors" id="description"
                                                              name="description"
                                                              rows="2">{{$tabPanel->description }}</textarea>
                                                    <div class="text-muted fs-7">Bu alan zorunlu değildir.</div>
                                                </div>
                                            </div>
                                            <div class="mb-10 row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input class="form-control" name="button_text"
                                                           value="{{ $tabPanel->button_text }}" required/>
                                                    <div class="text-muted fs-7">Bu alan zorunludur.</div>
                                                </div>
                                            </div>
                                            <div class="mb-10 row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    ...
                                                    <input class="form-control" name="sort_order" type="number"
                                                           value="{{ $tabPanel->sort_order }}" min="0" max="99"/>
                                                    <div class="text-muted fs-7">Bu alan zorunludur.</div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label class="required form-label">Durum</label>
                                                    <select name="is_active" class="form-control col-sm-3" required>
                                                        <option @if ($tabPanel->is_active == 1) selected
                                                                @endif value="1">Aktif
                                                        </option>
                                                        <option @if ($tabPanel->is_active == 0) selected
                                                                @endif value="0">Pasif
                                                        </option>
                                                    </select>
                                                    <div class="text-muted fs-7">Bu alan zorunludur.</div>
