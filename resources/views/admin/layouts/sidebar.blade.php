        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
               ...
               {{--  <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link " href="{{ route('reference.index') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link {{request()->routeIs('partner.*') ? 'active' : ''}}" href="{{ route('partner.index') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                        ...
                        <span class="menu-title">Kurum Yönetimi</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link "
    ...
    <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
        <a href="#" style="cursor: inherit"
           ...
           data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="">
            <span class="btn-label">Smart Grup v1.0.0</span>
