...
class ServiceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $securityServices = [
            ...
            ['title' => 'Fabrika Güvenliği',                    'description' => 'Üretim tesislerinde vardiyalı güvenlik, araç giriş-çıkış kontrolü ve personel güvenliği hizmetleri sunuyoruz.',               'sort_order' => 3],
